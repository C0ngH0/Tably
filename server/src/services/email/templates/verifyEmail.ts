...
export function buildVerificationEmail({
  ...
  return {
    to: toEmail,
    subject: "Verify your SplitSnap email",
    text: [
      "Verify your SplitSnap email",
      "",
      "Confirm this email address by opening the link below:",
      verificationUrl,
      "",
      "If you did not create a SplitSnap account, you can ignore this email.",
    ].join("\n"),
    html: `
      <div style="font-family: Arial, sans-serif; color: #0f172a;">
        ...
        <p>If you did not create a SplitSnap account, you can ignore this email.</p>
      </div>
    `,
  };
}
